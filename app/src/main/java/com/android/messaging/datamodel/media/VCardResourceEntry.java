...
public class VCardResourceEntry {
    ...
    public String getDisplayAddress() {
        List<VCardEntry.PostalData> postalList = mVCard.getPostalList();
    ...
    public String getNotes() {
        List<VCardEntry.NoteData> notes = mVCard.getNotes();
    ...
    private static List<VCardResourceEntryDestinationItem> getContactInfoFromVCardEntry(
        ...
        if (vcard.getPhoneList() != null) {
            for (final VCardEntry.PhoneData phone : vcard.getPhoneList()) {
        ...
        if (vcard.getEmailList() != null) {
            for (final VCardEntry.EmailData email : vcard.getEmailList()) {
        ...
        if (vcard.getPostalList() != null) {
            for (final VCardEntry.PostalData postalData : vcard.getPostalList()) {
                String type;
                try {
                    type = resources.
        ...
        if (vcard.getImList() != null) {
            for (final VCardEntry.ImData imData : vcard.getImList()) {
                String type = null;
                try {
                    type = resources.
        ...
        if (vcard.getOrganizationList() != null) {
            for (final VCardEntry.OrganizationData organtization : vcard.getOrganizationList()) {
                String type = null;
                try {
        ...
        if (vcard.getWebsiteList() != null) {
            for (final VCardEntry.WebsiteData web : vcard.getWebsiteList()) {
        ...
        if (vcard.getNotes() != null) {
            for (final VCardEntry.NoteData note : vcard.getNotes()) {
    ...
    private static String formatAddress(final VCardEntry.PostalData postalData) {
